...
namespace GPOyun.NPC
{
    ...
    public class NPCController : MonoBehaviour
    {
        ...
        private UtilityAI.NPCBrain _brain;
        private UtilityAI.NPCSenses _senses;
        public UtilityAI.NPCBrain Brain => _brain;
        public UtilityAI.NPCSenses Senses => _senses;
        ...
        private void Awake()
        {
            ...
            _brain = gameObject.AddComponent<UtilityAI.NPCBrain>();
            _senses = gameObject.AddComponent<UtilityAI.NPCSenses>();
        ...
        private void Start()
        {
            ...
            if (_brain != null) _brain.Initialize(this, _needs, _appraisalEngine, _actionPlanner);
            if (_senses != null) _senses.Initialize(this);
                        ...
                        else
                        {
                            ...
                            if (GPOyun.Core.ServiceLocator.Get<GPOyun.Core.RelationshipMatrix>() != null)
                            {
                                if (story.Category == NewsCategory.Scandal || story.Category == NewsCategory.Disaster)
                                {
                                    ...
                                    GPOyun.Core.ServiceLocator.Get<GPOyun.Core.RelationshipMatrix>().ModifyRelationship(NpcId, targetNpc.NpcId, -12);
                                    TriggerReaction("[FLAME]", VisualUtils.Terracotta);
                                }
                                else
                                {
                                    // Heroics/Local stories increase reputation!
                                    GPOyun.Core.ServiceLocator.Get<GPOyun.Core.RelationshipMatrix>().ModifyRelationship(NpcId, targetNpc.NpcId, +10);
