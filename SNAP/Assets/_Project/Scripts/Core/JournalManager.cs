...
namespace GPOyun.Core
{
    ...
    public class JournalManager : MonoBehaviour
    {
        ...
        public void AddObservation(string description, Color threadColor)
        {
            ...
            if (GPOyun.Core.ServiceLocator.Get<GPOyun.Managers.TimeManager>() != null)
            {
                timeStr = $"Phase {GPOyun.Core.ServiceLocator.Get<GPOyun.Managers.TimeManager>().CurrentPhase} ({GPOyun.Core.ServiceLocator.Get<GPOyun.Managers.TimeManager>().GetFormattedTime()})";
            }
